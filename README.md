...
```bash
docker pull crispim/crisp-status-local:v1.3.5
```
...
```bash
docker run -v /path/to/your/crisp-status-local/config.cfg:/etc/crisp-status-local.cfg crispim/crisp-status-local:v1.3.5
```
